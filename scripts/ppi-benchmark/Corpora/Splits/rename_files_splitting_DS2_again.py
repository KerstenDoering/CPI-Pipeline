...
"""
    ...
    This script will be called by SL_pipeline_DS2.sh to rename the all-paths graph kernel cross-validation files from test-<number> to DS2<number>.txt. 
"""
...
for index,name in enumerate(list_of_files):
    ...
    new_name = "DS2"+str(file_number)+".txt"
