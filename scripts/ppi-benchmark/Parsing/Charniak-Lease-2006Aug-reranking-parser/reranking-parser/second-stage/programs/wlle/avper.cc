...
//
// Mark Johnson, 24th October 2003, last modified 23rd Jan 2004
//
...
const char usage[] =
"avper version of 23rd January, 2004\n"
"\n"
"Usage: avper [-N nruns] [-b burnin] [-c weightdecay] [-d debug] [-e evalfile] [-f] [-g]\n"
"             [-n nepochs] [-o outfile] [-r reduce] [-s randseed] < traindata\n"
"\n"
"where:\n"
"\n"
...
int main(int argc, char **argv)
{
  ...
  char c, *cp;
  while ((c = getopt(argc, argv, "N:f:gb:c:d:n:o:r:e:s:")) != -1)
    switch (c) {
    case 'N':
