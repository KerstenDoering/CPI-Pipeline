...
# this script reads identifiers from DS3.xml-ptb-s.txt and adds them to DS3.xml-ptb-s.txt-parsed.txt with tab separation
...
# get tags
tags = []
infile_tags = open("DS3.xml-ptb-s.txt","r")
for line in infile_tags:
    # a line looks like this:
    # <s DS3.d0.s0> Bestrophin-1  enables Ca2+-activated Cl-conductance in epithelia. </s>
...
infile_parsed = open("DS3.xml-ptb-s.txt-parsed.txt","r")
# save modified version
outfile = open("DS3.xml-ptb-s.txt-parsed_modified.txt","w")
