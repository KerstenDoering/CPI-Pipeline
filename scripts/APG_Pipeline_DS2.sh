...
cd ..
mkdir -p export_step6/splits-test-train
mkdir -p export_step6/splits-test-train/DS2
...
mkdir -p ppi-benchmark/Experiments/APG/CV/
cp run.py ppi-benchmark/Experiments/APG/CV/run.py  ##
cd ppi-benchmark/Experiments
make experiment Corpora="DS2" Kernel="APG" expType="CV"

exit
# the main results are given in ppi-benchmark/Experiments/APG/CV/DS2.sql as well as in ppi-benchmark/Experiments/APG/CV/predict/DS2
