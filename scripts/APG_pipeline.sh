...
then
    ...
    ##cp -r CPI-corpora-preparing/export_step6/splits-test-train/DS/ ppi-benchmark/Corpora/splits-test-train/ ##
    rm -rf ppi-benchmark/Corpora/APG/CV/corpus/DS ##

    mkdir -p ppi-benchmark/Corpora/APG/
    mkdir -p ppi-benchmark/Corpora/APG/CV/
    mkdir -p ppi-benchmark/Corpora/APG/CV/corpus/
    cp -r CPI-corpora-preparing/export_step6/CV/DS/ ppi-benchmark/Corpora/APG/CV/corpus/
