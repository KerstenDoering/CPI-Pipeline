...
#        print TF_int_list
        ...
        if curr_pmid == pre_pmid :
            ...
            for i in range(0,len(entity_list)) :
                outfile.write("            <entity id=\"DS1.d"+str(doc_num-1)+".s"+str(sent_num)+".e"+str(i)+"\" origId=\""+entity_list[i][1]+"\" charOffset=\""+entity_list[i][3]+"\" type=\""+entity_list[i][0]+"\" text="+quoteattr(entity_list[i][2])+"/>"+"\n")
        ...
        # if the current PubMed ID changed in comparison to the last parsed sentences
            ...
            for i in range(0,len(entity_list)) :
                outfile.write("            <entity id=\"DS1.d"+str(doc_num)+".s"+str(sent_num)+".e"+str(i)+"\" origId=\""+entity_list[i][1]+"\" charOffset=\""+entity_list[i][3]+"\" type=\""+entity_list[i][0]+"\" text="+quoteattr(entity_list[i][2])+"/>"+"\n")
            # build entity tags
