...
if __name__=="__main__":
    ...
    parser.add_option("-o", "--output", dest="o", help='name of the output file',default="DS2.xml")
    ...
    outfile.write("<corpus source=\"DS2\">"+"\n")
...
#        print TF_int_list
        ...
        if curr_pmid == pre_pmid :
            ...
            outfile.write("        <sentence id=\"DS2.d"+str(doc_num-1)+".s"+str(sent_num)+"\" origId=\""+str(pmid_sent_num)+"\" text="+quoteattr(pur_sent_text)+">"+"\n")
            ...
            origId = "DS2.d"+str(doc_num-1)+".s"+str(sent_num)
        ...
        # if the current PubMed ID changed in comparison to the last parsed sentences
            ...
            outfile.write("    <document id=\"DS2.d"+str(doc_num)+"\" origId=\""+str(curr_pmid)+"\">"+"\n")
